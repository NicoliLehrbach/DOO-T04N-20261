...
public class Serie {
    ...
    // Recebe gêneros em texto vindos do JSON
    public void setGenerosTexto(String generosTexto) {

        if (generosTexto == null || generosTexto.isEmpty()) {
            this.generos = new ArrayList<String>();
        } else {

            this.generos = new ArrayList<String>(
                    Arrays.asList(generosTexto.split(", "))
            );
