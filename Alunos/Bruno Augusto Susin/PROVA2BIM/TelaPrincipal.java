...
public class TelaPrincipal extends JFrame {
    ...
    private final Color color_title = new Color(69, 210, 181);
    private final Color color_button = new Color(9, 51, 58);

    // Construtor da tela principal.
    public TelaPrincipal() {
        usuario = jsonService.carregarUsuario();

        setTitle("MultiSeries");
        setSize(1700, 860);
    ...
    private void montarTopo() {
        ...
        JLabel titulo = new JLabel("MultiSeries");
    ...
    private JPanel montarPainelBusca() {
        ...
        JButton btnPesquisar = criarBotao("Pesquisar", 250);
